...
public class TelaJedi extends JFrame {
    ...
    public void btnSalvarClick(ActionEvent e) {
        ControleJedi controleJedi = new ControleJedi(new Jedi());
        ...
        switch (JOptionPane.showConfirmDialog(this, "Você deseja salvar?", "Confirmação", JOptionPane.YES_NO_OPTION)) {
            ...
            case JOptionPane.YES_OPTION:
                String dados = nome.getText() + ',' + altura.getText() + ',' + idade.getText();
                controleJedi.salvarJedi(dados);
                try {
                    controleJedi.escreverArquivoJedi();
                } catch (Exception e1) {
